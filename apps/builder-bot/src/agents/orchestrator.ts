...
Ответь СТРОГО в формате JSON:
{
  ...
  "summary": "1 предложение что делает агент"
      ...
      // Fallback: используем описание пользователя как system prompt
      systemPrompt = `Ты — AI-агент. Твоя задача: ${description}\n\nНа каждом тике анализируй ситуацию используя доступные tools, и отправляй уведомления пользователю через notify() когда есть важная информация.`;
